 ...
 */
function mp_stacks_sociallinks_ajax_admin_css( $stylesheets, $metabox_id ){
	...
	//Enqueue Admin CSS
	$stylesheets['mp_stacks_sociallinks_css'] = plugins_url( 'css/admin-sociallinks.css?ver=' . MP_STACKS_SOCIALLINKS_VERSION, dirname( __FILE__ ) );
	
	//Enqueue Social Icons
	$stylesheets['mp-stacks-sociallinks-icons'] = plugins_url( '/fonts/fontello/css/fontello.css?ver=' . MP_STACKS_SOCIALLINKS_VERSION, dirname( __FILE__ ) );
	
	return $stylesheets;

}
add_filter( 'mp_core_metabox_ajax_admin_css_stylesheets', 'mp_stacks_sociallinks_ajax_admin_css', 10, 2 );